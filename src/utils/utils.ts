...
export function formatTimestampToDate(timestamp: number) {
    // FIXME: A bit of a critical issue here. Timestamps need to be UTC -> PST
    // local machine date seems to be used here. Which makes sense as Enki
    // runs on Syragons pc but can't be deployed to a server without locale 
    // adjustments.
